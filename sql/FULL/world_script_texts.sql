...
-- Dalaran guards
UPDATE `creature_template` SET `ScriptName`='poi_dalaran' WHERE (`entry` BETWEEN 32670 AND 32700) AND (`IconName`='Directions');
DELETE FROM `npc_text` WHERE `ID` IN 
	(14009, 13993, 13992, 14006, 14005, 13973, 13961, 13960, 13969, 13976, 14010, 14007, 14003, 13977, 14004, 14015, 14002, 14251, 14008, 13975, 14001, 14000, 13999, 14117);
INSERT IGNORE INTO `npc_text`(`ID`, `text0_0`, `text0_1`) VALUES 
	(14014,"Please respect the laws of Dalaran while you are here, stranger.$B$BWere you lost? Is there something I might help you find?","Please respect the laws of Dalaran while you are here, stranger.$B$BWere you lost? Is there something I might help you find?"),
	...
	(14174,"Necessary for imbuing your spells and abilities with Glyphs, the Lexicon of Power is an invaluable resource for everyone.  These ancient tomes are always found near inscription trainers.","Necessary for imbuing your spells and abilities with Glyphs, the Lexicon of Power is an invaluable resource for everyone.  These ancient tomes are always found near inscription trainers."),
