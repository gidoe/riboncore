...
#ifndef RIBONCORE_LOG_H
#define RIBONCORE_LOG_H
...
class Log : public Ribon::Singleton<Log, Ribon::ClassLevelLockable<Log, ACE_Thread_Mutex> >
{
    friend class Ribon::OperatorNew<Log>;
    Log();
    ~Log();
...
#define sLog Ribon::Singleton<Log>::Instance()

#ifdef RIBON_DEBUG
#define DEBUG_LOG Ribon::Singleton<Log>::Instance().outDebug
#else
#define DEBUG_LOG
#endif

// primary for script library
void RIBON_DLL_SPEC outstring_log(const char * str, ...) ATTR_PRINTF(1,2);
void RIBON_DLL_SPEC detail_log(const char * str, ...) ATTR_PRINTF(1,2);
void RIBON_DLL_SPEC debug_log(const char * str, ...) ATTR_PRINTF(1,2);
void RIBON_DLL_SPEC error_log(const char * str, ...) ATTR_PRINTF(1,2);
void RIBON_DLL_SPEC error_db_log(const char * str, ...) ATTR_PRINTF(1,2);
#endif
