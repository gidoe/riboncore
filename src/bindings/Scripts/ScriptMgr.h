...
#define DEFAULT_TEXT        "<Ribon Script Text Entry Missing!>"
...
#ifdef WIN32
  #define RIBON_DLL_EXPORT extern "C" __declspec(dllexport)
#elif defined( __GNUC__ )
#define RIBON_DLL_EXPORT extern "C"
#else
#define RIBON_DLL_EXPORT extern "C" export
#endif
