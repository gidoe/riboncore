    ...
    void JustDied(Unit* pVictim)
    {
        switch (rand()%5)
        {
            ...
            case 2:
                ...
                {
                    Creature* pSummoned = DoSpawnCreature(NPC_COLOSSUS_LURKER, rand()%5,rand()%5,0,0,TEMPSUMMON_CORPSE_DESPAWN, 30000);
            ...
            case 3:
                ...
                {
                    Creature* pSummoned = DoSpawnCreature(NPC_COLOSSUS_RAGER, rand()%5,rand()%5,0,0,TEMPSUMMON_CORPSE_DESPAWN, 30000);
                    Unit* pTarget = SelectUnit(SELECT_TARGET_RANDOM,0);
                    if (pSummoned && pTarget)
                            pSummoned->AI()->AttackStart(pTarget);
                }
