            ...
            if(m_creature->GetEntry() == ABOMINATION)
            {
                ...
                switch(OverrunType)
                {
                    case 0:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[43][0]+irand(-3,3), AllianceOverrunWP[43][1]+irand(-3,3), AllianceOverrunWP[43][2]);
                     ...
                     case 1:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[44][0]+irand(-3,3), AllianceOverrunWP[44][1]+irand(-3,3), AllianceOverrunWP[44][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 18;
                        Start(true, true, true);
                        break;
            ...
            if(m_creature->GetEntry() == GHOUL)
            {
                ...
                switch(OverrunType)
                {
                    case 0:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[2][0]+irand(-3,3), AllianceOverrunWP[2][1]+irand(-3,3), AllianceOverrunWP[2][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 5;
                        Start(true, true, true);
                        break;
                    case 1:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[5][0]+irand(-3,3), AllianceOverrunWP[5][1]+irand(-3,3), AllianceOverrunWP[5][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 6;
                        Start(true, true, true);
                        break;
                    case 2:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[9][0]+irand(-3,3), AllianceOverrunWP[9][1]+irand(-3,3), AllianceOverrunWP[9][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 7;
                        Start(true, true, true);
                        break;
                    case 3:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[12][0]+irand(-3,3), AllianceOverrunWP[12][1]+irand(-3,3), AllianceOverrunWP[12][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 6;
                        Start(true, true, true);
                        break;
                    case 4:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[15][0]+irand(-3,3), AllianceOverrunWP[15][1]+irand(-3,3), AllianceOverrunWP[15][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 6;
                        Start(true, true, true);
                        break;
                    case 5:
                        ...
                        m_creature->SetCombatStartPosition(AllianceOverrunWP[21][0]+irand(-3,3), AllianceOverrunWP[21][1]+irand(-3,3), AllianceOverrunWP[21][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 9;
                        Start(true, true, true);
                        break;
            ...
            if(m_creature->GetEntry() == GHOUL)
            {
                ...
                switch(OverrunType)
                {
                    case 0:
                        ...
                        m_creature->SetCombatStartPosition(HordeOverrunWP[19][0], HordeOverrunWP[19][1], HordeOverrunWP[19][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 8;
                        Start(true, true, true);
                        break;
                    case 1:
                        ...
                        m_creature->SetCombatStartPosition(HordeOverrunWP[20][0], HordeOverrunWP[20][1], HordeOverrunWP[20][2]);
                        SetDespawnAtEnd(false);
                        LastOverronPos = 8;
                        Start(true, true, true);
                        break;
...
struct mob_gargoyleAI : public hyjal_trashAI
{
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        if(IsOverrun && !m_creature->SelectHostilTarget() || !m_creature->getVictim())
        {
