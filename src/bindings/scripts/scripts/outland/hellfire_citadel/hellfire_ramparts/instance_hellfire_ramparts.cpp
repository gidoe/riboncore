...
struct SCRIPTS_DLL_DECL instance_ramparts : public ScriptedInstance
{
    ...
    {
        debug_log("RSCR: Instance Ramparts: SetData received for type %u with data %u",uiType,uiData);
