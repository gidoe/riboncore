...
struct SCRIPTS_DLL_DECL boss_the_lurker_belowAI : public Scripted_NoMovementAI
{
...
struct SCRIPTS_DLL_DECL mob_coilfang_ambusherAI : public Scripted_NoMovementAI
{
