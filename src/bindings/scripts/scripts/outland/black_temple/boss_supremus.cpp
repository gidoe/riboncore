...
struct SCRIPTS_DLL_DECL molten_flameAI : public NullCreatureAI
{
...
struct SCRIPTS_DLL_DECL boss_supremusAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_volcanoAI : public Scripted_NoMovementAI
{
