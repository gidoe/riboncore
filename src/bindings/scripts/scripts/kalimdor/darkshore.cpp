...
struct SCRIPTS_DLL_DECL npc_kerlonianAI : public FollowerAI
{
...
struct SCRIPTS_DLL_DECL npc_prospector_remtravelAI : public npc_escortAI
{
...
struct SCRIPTS_DLL_DECL npc_threshwackonatorAI : public FollowerAI
{
