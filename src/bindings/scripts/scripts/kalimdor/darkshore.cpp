...
struct RIBON_DLL_DECL npc_kerlonianAI : public FollowerAI
{
...
struct RIBON_DLL_DECL npc_prospector_remtravelAI : public npc_escortAI
{
...
struct RIBON_DLL_DECL npc_threshwackonatorAI : public FollowerAI
{
