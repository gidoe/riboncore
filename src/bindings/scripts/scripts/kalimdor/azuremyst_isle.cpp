...
struct SCRIPTS_DLL_DECL npc_draenei_survivorAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_engineer_spark_overgrindAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_injured_draeneiAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_magwinAI : public npc_escortAI
{
...
struct SCRIPTS_DLL_DECL npc_geezleAI : public ScriptedAI
{
    ...
    void CompleteQuest()
    {
        ...
        Ribon::AnyPlayerInObjectRangeCheck checker(m_creature, radius);
        Ribon::PlayerListSearcher<Ribon::AnyPlayerInObjectRangeCheck> searcher(m_creature, players, checker);
...
struct SCRIPTS_DLL_DECL npc_nestlewood_owlkinAI : public ScriptedAI
{
