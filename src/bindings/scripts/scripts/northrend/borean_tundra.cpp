...
struct SCRIPTS_DLL_DECL npc_sinkhole_kill_creditAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL npc_khunok_the_behemothAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_nerubar_victimAI : public ScriptedAI
{
