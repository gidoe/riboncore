...
#define GOSSIP_TEXT_ESE_DALARAN               "Eastern Sewer Entrance"
#define GOSSIP_TEXT_WSE_DALARAN               "Western Sewer Entrance"
#define GOSSIP_TEXT_WE_DALARAN                "Well Entrance"
#define GOSSIP_TEXT_AQ_DALARAN                "The Alliance Quarter"
#define GOSSIP_TEXT_HQ_DALARAN                "The Horde Quarter"
#define GOSSIP_TEXT_NB_DALARAN                "Northern Bank"
#define GOSSIP_TEXT_SB_DALARAN                "Southern Bank"
#define GOSSIP_TEXT_SE_DALARAN                "Sewers"

#define GOSSIP_TEXT_VIOLET_CITADEL_DALARAN    "The Violet Citadel"
#define GOSSIP_TEXT_VIOLET_HOLD_DALARAN       "The Violet Hold"
#define GOSSIP_TEXT_ANTONIDAS_MEMORIAL        "Antonidas Memorial"
#define GOSSIP_TEXT_RUNEWEAVER_SQUARE         "Runeweaver Square"
#define GOSSIP_TEXT_THE_EVENTIDE_DALARAN      "The Eventide"
#define GOSSIP_TEXT_CEMETERY_DALARAN          "Cemetery"
#define GOSSIP_TEXT_KRASUS_LANDING_DALARAN    "Krasus\' Landing"

#define GOSSIP_TEXT_ALLIANCE_QUARTER_DALARAN  "The Alliance Quarter"
#define GOSSIP_TEXT_HORDE_QUARTER_DALARAN     "The Horde Quarter"
...
bool GossipHello_dalaran_poi(Player* pPlayer, Creature* pCreature)
{
	...
	pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_AUCTIONHOUSE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
	...
	pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_BATTLEMASTER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
	pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CAPITAL_PORTALS, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
	pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FLIGHTMASTER, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
...
void SendDefaultMenu_dalaran(Player* pPlayer, Creature* pCreature, uint32 action)
{
	...
	{
	//Arena
	case GOSSIP_ACTION_INFO_DEF + 1: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ESE_DALARAN, GOSSIP_SENDER_ARENA, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WSE_DALARAN, GOSSIP_SENDER_ARENA, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WE_DALARAN, GOSSIP_SENDER_ARENA, GOSSIP_ACTION_INFO_DEF + 3);
		pPlayer->SEND_GOSSIP_MENU(13976, pCreature->GetGUID());
		break;
	//Action House
	case GOSSIP_ACTION_INFO_DEF + 2:pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_AQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->SEND_GOSSIP_MENU(14010, pCreature->GetGUID());
		break;
	//Bank
	case GOSSIP_ACTION_INFO_DEF + 3:pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_NB_DALARAN, GOSSIP_SENDER_BANK, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SB_DALARAN, GOSSIP_SENDER_BANK, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SE_DALARAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
	...
	case GOSSIP_ACTION_INFO_DEF + 4: 
		...
		break;
	//Battlemasters
	case GOSSIP_ACTION_INFO_DEF + 5: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_AQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->SEND_GOSSIP_MENU(13977, pCreature->GetGUID());
		break;
	//Portals
	case GOSSIP_ACTION_INFO_DEF + 6: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_AQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->SEND_GOSSIP_MENU(13977, pCreature->GetGUID());
		break;
	//Flight Master
	...
	case GOSSIP_ACTION_INFO_DEF + 8: pPlayer->SEND_POI(5767.96, 627.193, 7, 6, 0, "Dalaran Visitor Center");
		...
		break;
	//Inn
	case GOSSIP_ACTION_INFO_DEF + 9: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE_INN, GOSSIP_SENDER_I, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE_INN, GOSSIP_SENDER_I, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SE_DALARAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
	...
	case GOSSIP_ACTION_INFO_DEF + 11:
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_INN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_BANK, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_KRASUS_LANDING_DALARAN, GOSSIP_SENDER_MAIL, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->SEND_GOSSIP_MENU(14008, pCreature->GetGUID());
		break;
	//Points of Inetrest
	case GOSSIP_ACTION_INFO_DEF + 12:
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_AQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HQ_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_VIOLET_CITADEL_DALARAN, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_VIOLET_HOLD_DALARAN, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SE_DALARAN, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TRADE_DISTRICT, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 3);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_KRASUS_LANDING_DALARAN, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 4);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ANTONIDAS_MEMORIAL, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 5);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_RUNEWEAVER_SQUARE, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 6);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_THE_EVENTIDE_DALARAN, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 7);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CEMETERY_DALARAN, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 8);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_LEXICON, GOSSIP_SENDER_POI, GOSSIP_ACTION_INFO_DEF + 9);
	...
	case GOSSIP_ACTION_INFO_DEF + 13: pPlayer->SEND_POI(5859.68, 557.571, 7, 6, 0, "Dalaran Stable Master");
		...
		break;
	//Trainer
	case GOSSIP_ACTION_INFO_DEF + 14: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLASS_TRAINER, GOSSIP_SENDER_TRAINERS, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CWF_TRAINER, GOSSIP_SENDER_TRAINERS, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PORTAL_TRAINER, GOSSIP_SENDER_TRAINERS, GOSSIP_ACTION_INFO_DEF + 3);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PROFESSION_TRAINER, GOSSIP_SENDER_TRAINERS, GOSSIP_ACTION_INFO_DEF + 4);
		pPlayer->SEND_GOSSIP_MENU(14000, pCreature->GetGUID());
		break;
	//Vendors
	case GOSSIP_ACTION_INFO_DEF + 15: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ARMOR, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLOTHING, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_EMBLEM_GEAR, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 3);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FLOWERS, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 4);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FRUIT, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 5);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_GENERAL_GOODS, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 6);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_JEWELRY, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 7);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PSAEM, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 8);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PPAC, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 9);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_RAMG, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 10);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TOYS, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 11);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TRADE_SUPPLY, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 12);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TRAOI, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 13);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WEAPONS, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 14);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_WAC, GOSSIP_SENDER_VENDORS, GOSSIP_ACTION_INFO_DEF + 15);
...
void SendMailMenu_dalaran(Player* pPlayer, Creature* pCreature, uint32 action)
{
	switch(action)
	{
	case GOSSIP_ACTION_INFO_DEF + 1:pPlayer->SEND_POI(5831.95, 507.86, 7, 6, 0, GOSSIP_TEXT_KRASUS_LANDING_DALARAN);
...
void SendTrainersMenu_dalaran(Player* pPlayer, Creature* pCreature, uint32 action)
{
	...
	case GOSSIP_ACTION_INFO_DEF + 3: pPlayer->SEND_POI(5807.69, 586.88, 7, 6, 0, "Dalaran Mage Trainer");
		pPlayer->SEND_GOSSIP_MENU(13999, pCreature->GetGUID());
		break;
	case GOSSIP_ACTION_INFO_DEF + 4: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALCHEMY, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_BLACKSMITHING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_COOKING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 3);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ENCHANTING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 4);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ENGINEERING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 5);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FIRSTAID, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 6);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_FISHING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 7);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HERBALISM, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 8);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_INSCRIPTION, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 9);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_JEWELCRAFTING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 10);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_LEATHERWORKING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 11);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MINING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 12);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SKINNING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 13);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_TAILORING, GOSSIP_SENDER_PROFTRAINER, GOSSIP_ACTION_INFO_DEF + 14);
...
void SendVendorsMenu_dalaran(Player* pPlayer, Creature* pCreature, uint32 action)
{
	switch(action)
	{
	case GOSSIP_ACTION_INFO_DEF + 1:pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_CLOTH_ARMOR, GOSSIP_SENDER_ARMOR, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_LEATHER_ARMOR, GOSSIP_SENDER_ARMOR, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MAIL_ARMOR, GOSSIP_SENDER_ARMOR, GOSSIP_ACTION_INFO_DEF + 3);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_PLATE_ARMOR, GOSSIP_SENDER_ARMOR, GOSSIP_ACTION_INFO_DEF + 4);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SHIELDS, GOSSIP_SENDER_ARMOR, GOSSIP_ACTION_INFO_DEF + 5);
	...
	case GOSSIP_ACTION_INFO_DEF + 2:pPlayer->SEND_POI(5786.20, 647.08, 7, 6, 0, "Dalaran Cloth Armor & Clothing");
		...
		break;
	case GOSSIP_ACTION_INFO_DEF + 3: pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE_QUARTER_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE_QUARTER_DALARAN, GOSSIP_SENDER_Q, GOSSIP_ACTION_INFO_DEF + 2);
	...
	case GOSSIP_ACTION_INFO_DEF + 13:pPlayer->SEND_POI(5762.18, 638.81, 7, 6, 0, "Dalaran Trinkets");
		...
		break;
	case GOSSIP_ACTION_INFO_DEF + 14:pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_MELEE_WEAPONS, GOSSIP_SENDER_WEAPONS, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_RATW, GOSSIP_SENDER_WEAPONS, GOSSIP_ACTION_INFO_DEF + 2);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_SAW, GOSSIP_SENDER_WEAPONS, GOSSIP_ACTION_INFO_DEF + 3);
...
void SendProfTrainerMenu_dalaran(Player* pPlayer, Creature* pCreature, uint32 action)
{
	...
	case GOSSIP_ACTION_INFO_DEF + 2:pPlayer->SEND_POI(5900.17, 686.36, 7, 6, 0, "Dalaran Blacksmithing Trainer");
		...
		break;
	case GOSSIP_ACTION_INFO_DEF + 3:pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_ALLIANCE_INN, GOSSIP_SENDER_I, GOSSIP_ACTION_INFO_DEF + 1);
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TEXT_HORDE_INN, GOSSIP_SENDER_I, GOSSIP_ACTION_INFO_DEF + 2);
...
struct SCRIPTS_DLL_DECL guard_shattrath_aldorAI : public guardAI
{
...
struct SCRIPTS_DLL_DECL guard_shattrath_scryerAI : public guardAI
{
