...
struct RIBON_DLL_DECL flesh_tentacleAI : public Scripted_NoMovementAI
{
...
struct RIBON_DLL_DECL eye_of_cthunAI : public Scripted_NoMovementAI
{
    eye_of_cthunAI(Creature *c) : Scripted_NoMovementAI(c)
    {
        pInst = c->GetInstanceData();
        if (!pInst)
            error_log("RSCR: No Instance eye_of_cthunAI");
    }
...
struct RIBON_DLL_DECL cthunAI : public Scripted_NoMovementAI
{
...
struct RIBON_DLL_DECL eye_tentacleAI : public Scripted_NoMovementAI
{
...
struct RIBON_DLL_DECL claw_tentacleAI : public Scripted_NoMovementAI
{
...
struct RIBON_DLL_DECL giant_claw_tentacleAI : public Scripted_NoMovementAI
{
...
struct RIBON_DLL_DECL giant_eye_tentacleAI : public Scripted_NoMovementAI
{
...
void flesh_tentacleAI::JustDied(Unit* killer)
{
    if (!Parent)
    {
        error_log("RSCR: flesh_tentacle: No Parent variable");
        return;
    }
    ...
    else error_log("RSCR: flesh_tentacle: No Cthun");
}
