...
struct RIBON_DLL_DECL mob_mature_netherwing_drakeAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL mob_enslaved_netherwing_drakeAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL mob_dragonmaw_peonAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL npc_overlord_morghorAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL npc_earthmender_wildaAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 i)
    {
       ...
       void SummonAssassin()
       {
           ...
           else error_log("RSCR ERROR: Coilskar Assassin couldn't be summmoned");
       }
...
struct RIBON_DLL_DECL mob_illidari_spawnAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL mob_torloth_the_magnificentAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL npc_lord_illidan_stormrageAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL npc_enraged_spiritAI : public ScriptedAI
{
