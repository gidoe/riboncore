...
struct RIBON_DLL_DECL instance_shadow_labyrinth : public ScriptedInstance
{
    ...
    void OnCreatureCreate(Creature *creature, bool add)
    {
        switch(creature->GetEntry())
        {
            ...
            case 18796:
                ++FelOverseerCount;
                debug_log("RSCR: Shadow Labyrinth: counting %u Fel Overseers.",FelOverseerCount);
                break;
        }
    }
    ...
    void SetData(uint32 type, uint32 data)
    {
        switch(type)
        {
            ...
            case TYPE_OVERSEER:
                ...
                {
                    --FelOverseerCount;
                    debug_log("RSCR: Shadow Labyrinth: %u Fel Overseers left to kill.",FelOverseerCount);
                }
