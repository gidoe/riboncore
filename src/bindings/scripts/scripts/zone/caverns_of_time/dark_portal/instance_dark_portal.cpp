...
struct RIBON_DLL_DECL instance_dark_portal : public ScriptedInstance
{
    ...
    void UpdateBMWorldState(uint32 id, uint32 state)
    {
        ...
        }else debug_log("RSCR: Instance Black Portal: UpdateBMWorldState, but PlayerList is empty!");
    }
