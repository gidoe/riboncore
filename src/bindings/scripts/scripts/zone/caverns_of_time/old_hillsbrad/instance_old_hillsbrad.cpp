...
struct RIBON_DLL_DECL instance_old_hillsbrad : public ScriptedInstance
{
    ...
    Player* GetPlayerInMap()
    {
        ...
        debug_log("RSCR: Instance Old Hillsbrad: GetPlayerInMap, but PlayerList is empty!");
        return NULL;
    }
    ...
    void UpdateOHWorldState()
    {
        ...
        if (!players.isEmpty())
        {
            ...
            debug_log("RSCR: Instance Old Hillsbrad: UpdateOHWorldState, but PlayerList is empty!");
    }
