...
struct RIBON_DLL_DECL boss_archaedasAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL mob_archaedas_minionsAI : public ScriptedAI
{
...
struct RIBON_DLL_DECL mob_stonekeepersAI : public ScriptedAI
{
