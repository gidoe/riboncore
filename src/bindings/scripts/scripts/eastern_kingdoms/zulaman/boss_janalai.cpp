...
//        DoZoneInCombat();
    ...
    bool HatchAllEggs(uint32 uiAction) //1: reset, 2: isHatching all
    {
...

        {
            ...
            Ribon::AllCreaturesOfEntryInRange check(m_creature, MOB_EGG, 100);
    ...
    void Boom()
    {
...

        {
            ...
            Ribon::AllCreaturesOfEntryInRange check(m_creature, MOB_FIRE_BOMB, 100);
            Ribon::CreatureListSearcher<Ribon::AllCreaturesOfEntryInRange> searcher(m_creature, templist, check);
...
struct SCRIPTS_DLL_DECL mob_amanishi_hatcherAI : public ScriptedAI
{
    ...
    bool HatchEggs(uint32 num)
    {
...

        {
            ...
            Ribon::AllCreaturesOfEntryInRange check(m_creature, 23817, 50);
            Ribon::CreatureListSearcher<Ribon::AllCreaturesOfEntryInRange> searcher(m_creature, templist, check);
