...
struct SCRIPTS_DLL_DECL boss_nalorakkAI : public ScriptedAI
{
    ...
    void SendAttacker(Unit* target)
    {
...

        {
            ...
            Ribon::AllFriendlyCreaturesInGrid check(m_creature);
            Ribon::CreatureListSearcher<Ribon::AllFriendlyCreaturesInGrid> searcher(m_creature, templist, check);

            TypeContainerVisitor<Ribon::CreatureListSearcher<Ribon::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
