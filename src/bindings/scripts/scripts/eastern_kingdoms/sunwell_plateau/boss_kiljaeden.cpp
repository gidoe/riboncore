...
/*** Error messages ***/
#define ERROR_KJ_NOT_SUMMONED "RSCR ERROR: Unable to summon Kil'Jaeden for some reason"
...
//AI for Kalecgos
struct SCRIPTS_DLL_DECL boss_kalecgos_kjAI : public ScriptedAI
{
    ...
    void FindOrbs()
    {
        ...
        AllOrbsInGrid check;
        Ribon::GameObjectListSearcher<AllOrbsInGrid> searcher(me, orbList, check);
        TypeContainerVisitor<Ribon::GameObjectListSearcher<AllOrbsInGrid>, GridTypeMapContainer> visitor(searcher);
...
//AI for Kil'jaeden
struct SCRIPTS_DLL_DECL boss_kiljaedenAI : public Scripted_NoMovementAI
{
...
struct SCRIPTS_DLL_DECL mob_kiljaeden_controllerAI : public Scripted_NoMovementAI
{
...
struct SCRIPTS_DLL_DECL mob_hand_of_the_deceiverAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_felfire_portalAI : public Scripted_NoMovementAI
{
...
struct SCRIPTS_DLL_DECL mob_volatile_felfire_fiendAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_armageddonAI : public Scripted_NoMovementAI
{
...
//AI for Shield Orbs
struct SCRIPTS_DLL_DECL mob_shield_orbAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_sinster_reflectionAI : public ScriptedAI
{
