...
struct SCRIPTS_DLL_DECL boss_felmystAI : public ScriptedAI
{
    ...
    void DespawnSummons(uint32 entry)
    {
...

        {
            ...
            Ribon::AllCreaturesOfEntryInRange check(m_creature, entry, 100);
            Ribon::CreatureListSearcher<Ribon::AllCreaturesOfEntryInRange> searcher(m_creature, templist, check);

            TypeContainerVisitor<Ribon::CreatureListSearcher<Ribon::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
...
struct SCRIPTS_DLL_DECL mob_felmyst_vaporAI : public ScriptedAI
{
...
struct SCRIPTS_DLL_DECL mob_felmyst_trailAI : public ScriptedAI
{
