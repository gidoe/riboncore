...
bool AuthSocket::_HandleLogonProof()
{
    ...
    int accepted_versions[] = EXPECTED_RIBON_CLIENT_BUILD;
            ...
            if(QueryResult *loginfail = loginDatabase.PQuery("SELECT id, failed_logins FROM account WHERE username = '%s'", _safelogin.c_str()))
            {
                ...
                if( failed_logins >= MaxWrongPassCount )
                {
                    ...
                    if(WrongPassBanType)
                    {
                        ...
                        loginDatabase.PExecute("INSERT INTO account_banned VALUES ('%u',UNIX_TIMESTAMP(),UNIX_TIMESTAMP()+'%u','Ribon realmd','Failed login autoban',1)",
                    ...
                    else
                    {
                        ...
                        loginDatabase.PExecute("INSERT INTO ip_banned VALUES ('%s',UNIX_TIMESTAMP(),UNIX_TIMESTAMP()+'%u','Ribon realmd','Failed login autoban')",
