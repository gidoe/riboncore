...
// 3.1.3 build 9947
// 3.2.2a build 10505
// will support WoW, (1.12.1/2) WoW:TBC (2.4.3) and WoW:WotLK (3.1.3, 3.2.2a) client build 10505/9947/8606/5875/6005...

#define EXPECTED_RIBON_CLIENT_BUILD        {10505, 9947, 8606, 5875, 6005, 0}
