...
void Spell::EffectSanctuary(uint32 /*i*/)
{
    ...
    Ribon::AnyUnfriendlyUnitInObjectRangeCheck u_check(unitTarget, unitTarget, m_caster->GetMap()->GetVisibilityDistance());
    Ribon::UnitListSearcher<Ribon::AnyUnfriendlyUnitInObjectRangeCheck> searcher(unitTarget, targets, u_check);
