...
#ifndef RIBON_UNITAI_H
#define RIBON_UNITAI_H
...
class RIBON_DLL_SPEC PlayerAI : public UnitAI
{
    protected:
        Player* const me;
    public:
...
class RIBON_DLL_SPEC SimpleCharmedAI : public PlayerAI
{
    public:
