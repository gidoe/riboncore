...
#ifndef RIBON_GAMEEVENT_MGR_H
#define RIBON_GAMEEVENT_MGR_H
...
#define gameeventmgr Ribon::Singleton<GameEventMgr>::Instance()

RIBON_DLL_SPEC bool IsHolidayActive(HolidayIds id);
