...
bool LoadScriptingModule(char const* libName)
{
    ...
    if(   !(testScript->ScriptsInit         =(scriptCallScriptsInit         )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"ScriptsInit"         ))
        ...
        ||!(testScript->OnLogout            =(scriptCallOnLogout            )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnLogout"            ))
        ||!(testScript->OnPVPKill           =(scriptCallOnPVPKill           )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnPVPKill"           ))
        ||!(testScript->OnSpellCast         =(scriptCallOnSpellCast         )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnSpellCast"         ))
        ||!(testScript->OnGetXP             =(scriptCallOnGetXP             )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnGetXP"             ))
        ||!(testScript->OnGetMoney          =(scriptCallOnGetMoney          )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnGetMoney"          ))
        ||!(testScript->OnPlayerChat        =(scriptCallOnPlayerChat        )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnPlayerChat"        ))
        ||!(testScript->OnServerStartup     =(scriptCallOnServerStartup     )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnServerStartup"     ))
        ||!(testScript->OnServerShutdown    =(scriptCallOnServerShutdown    )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnServerShutdown"    ))
        ||!(testScript->OnAreaChange        =(scriptCallOnAreaChange        )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnAreaChange"        ))
        ||!(testScript->OnItemClick         =(scriptCallOnItemClick         )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnItemClick"         ))
        ||!(testScript->OnItemOpen          =(scriptCallOnItemOpen          )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnItemOpen"          ))
        ||!(testScript->OnGoClick           =(scriptCallOnGoClick           )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnGoClick"           ))
        ||!(testScript->OnCreatureKill      =(scriptCallOnCreatureKill      )RIBON_GET_PROC_ADDR(testScript->hScriptsLib,"OnCreatureKill"      ))
