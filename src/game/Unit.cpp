...
{
    std::list<Unit *> targets;
    Ribon::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, this, dist);
    Ribon::UnitListSearcher<Ribon::AnyUnfriendlyUnitInObjectRangeCheck> searcher(this, targets, u_check);
