...
#ifndef RIBON_GRIDSTATES_H
#define RIBON_GRIDSTATES_H

#include "Map.h"
#include "Object.h"

class SCRIPTS_DLL_DECL GridState
{
    public:
#ifdef RIBON_DEBUG
...
class SCRIPTS_DLL_DECL InvalidState : public GridState
{
    public:
...
class SCRIPTS_DLL_DECL ActiveState : public GridState
{
    public:
...
class SCRIPTS_DLL_DECL IdleState : public GridState
{
    public:
...
class SCRIPTS_DLL_DECL RemovalState : public GridState
{
    public:
