...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADBATTLEGROUND,    "SELECT bgid, bgteam, bgmap, bgx, bgy, bgz, bgo FROM character_battleground WHERE guid = '%u'", GUID_LOPART(m_guid));
...
void WorldSession::HandlePlayerLogin(LoginQueryHolder * holder)
{
    ...
    loginDatabase.PExecute("UPDATE account SET online = 1 WHERE id = '%u'", GetAccountId()); // really need this?
