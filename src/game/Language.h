...
enum RibonStrings
{
    ...
    LANG_SYSTEMMESSAGE_MODERATOR                       = 62,
    LANG_SYSTEMMESSAGE_GAMEMASTER                      = 63,
    LANG_SYSTEMMESSAGE_ADMINISTRATOR                   = 64,
    LANG_SYSANNOUNCE_COLOR                             = 65,
    LANG_SYSTEMMESSAGE_CONSOLE                         = 66,

	//
	// More Room for Level 0                           = 67-99
	//
    ...
    LANG_CURRENT_ENERGY                                = 124,    //Only Log
    ...
    LANG_COMMAND_REFRESHOBJECT                         = 283,
	...
	//
    // TICKET STRINGS NEED REWRITE                     = 288-296
    //
    ...
    LANG_ADDITEM                                       = 494,    //Only Log
    LANG_ADDITEMSET                                    = 495,    //Only Log
    LANG_REMOVEITEM                                    = 496,
    ...
    LANG_GAMEOBJECT_CURRENT                            = 523,    //Only Log
    ...
    LANG_SET_UINT                                      = 565,    //Only log
    LANG_SET_UINT_FIELD                                = 566,
    LANG_SET_FLOAT                                     = 567,    //Only log
    LANG_SET_FLOAT_FIELD                               = 568,
    LANG_GET_UINT                                      = 569,    //Only log
    LANG_GET_UINT_FIELD                                = 570,
    LANG_GET_FLOAT                                     = 571,    //Only log
    LANG_GET_FLOAT_FIELD                               = 572,
    LANG_SET_32BIT                                     = 573,    //Only log
    LANG_SET_32BIT_FIELD                               = 574,
    LANG_CHANGE_32BIT                                  = 575,    //Only log
	...
	//
    // End of Level 3 List (Part 1) - Continued at 1100
	//
    ...
    //
    // More Room for Battleground                      = 616-635
    //
    ...
    //
    // More Room for Battleground                      = 639-649
    //
    ...
    //
    // More Room for Battleground                      = 688-699
    // 
    ...
    //
    // More Room for Battleground/Arena                = 756-784
    //
	...
	//
    // More Room for generic strings                   = 788-799
    //

    //--Generic in-game strings--//
    ...
    //
    // More Room for generic in-game strings           = 816-999
    //
    ...
    //
    // More Room for Level 4 Chat (CLI only commands)  = 1015-1099
    //
    ...
    //
    // More Room for Level 3 (Part 2)                  = 1130-1199
    //
	...
	//
    // More Room for debug commands                    = 1202-1299
    //

    //
    // More Room for generic Commands                  = 1300-9999
    //
    ...
    //
    // More Room for AV and other strings             = 1334-1999
    //
    ...
    //
    // More Room for Ribon strings                     = 5020-6612
    // 
    ...
    //
    // More Room for other strings                     = 6617-7522
    //
    ...
    //
    // Reserved strings for not-offcial-data           = 10000-10999
    //                                                 
    ...
    LANG_WORLD_LOAD_LOCAL_STRINGS_LOADING              = 50016, // "Loading Localization strings..."
    LANG_WORLD_LOAD_LOCAL_CREATURE_EMPTY               = 50017, // ">> Loaded 0 creature locale strings. DB table `locales_creature` is empty."
    LANG_WORLD_LOAD_LOCAL_CREATURE_LOADED              = 50018, // ">> Loaded %lu creature locale strings"
    LANG_WORLD_LOAD_LOCAL_GO_EMPTY                     = 50019, // ">> Loaded 0 gameobject locale strings. DB table `locales_gameobject` is empty."
    LANG_WORLD_LOAD_LOCAL_GO_LOADED                    = 50020, // ">> Loaded %lu gameobject locale strings"
    LANG_WORLD_LOAD_LOCAL_ITEM_EMPTY                   = 50021, // ">> Loaded 0 Item locale strings. DB table `locales_item` is empty."
    LANG_WORLD_LOAD_LOCAL_ITEM_LOADED                  = 50022, // ">> Loaded %lu Item locale strings"
    LANG_WORLD_LOAD_LOCAL_QUEST_EMPTY                  = 50023, // ">> Loaded 0 Quest locale strings. DB table `locales_quest` is empty."
    LANG_WORLD_LOAD_LOCAL_QUEST_LOADED                 = 50024, // ">> Loaded %lu Quest locale strings"
    LANG_WORLD_LOAD_LOCAL_NPC_TEXT_EMPTY               = 50025, // ">> Loaded 0 NpcText locale strings. DB table `locales_npc_text` is empty."
    LANG_WORLD_LOAD_LOCAL_NPC_TEXT_LOADED              = 50026, // ">> Loaded %lu NpcText locale strings"
    LANG_WORLD_LOAD_LOCAL_PAGE_TEXT_STRINGS_EMPTY      = 50027, // ">> Loaded 0 PageText locale strings. DB table `locales_page_text` is empty."
    LANG_WORLD_LOAD_LOCAL_PAGE_TEXT_STRINGS_LOADED     = 50028, // ">> Loaded %lu PageText locale strings"
    LANG_WORLD_LOAD_LOCAL_NPC_OPTION_EMPTY             = 50029, // ">> Loaded 0 npc_option locale strings. DB table `locales_npc_option` is empty."
    LANG_WORLD_LOAD_LOCAL_NPC_OPTION_LOADED            = 50030, // ">> Loaded %lu npc_option locale strings"
    LANG_WORLD_LOAD_LOCAL_POI_EMPTY                    = 50031, // ">> Loaded 0 points_of_interest locale strings. DB table `locales_points_of_interest` is empty."
    LANG_WORLD_LOAD_LOCAL_POI_LOADED                   = 50032, // ">> Loaded %lu points_of_interest locale strings"
    LANG_WORLD_LOAD_LOCAL_STRINGS_LOADED               = 50033, // ">>> Localization strings loaded"
    LANG_WORLD_LOAD_PAGE_TEXTS_LOADING                 = 50034, // "Loading Page Texts..."
    LANG_WORLD_LOAD_PAGE_TEXTS_LOADED                  = 50035, // ">> Loaded %u page texts"
    LANG_WORLD_LOAD_PLAYER_INFO_CACHE_LOADING          = 50036, // "Loading Player info in cache..."
    LANG_WORLD_LOAD_PLAYER_INFO_CACHE_FAILED           = 50037, // "Loading Player Cache failed."
    LANG_WORLD_LOAD_PLAYER_INFO_CACHE_LOADED           = 50038, // ">> Loaded info about %d players"
    LANG_WORLD_LOAD_GO_TEMPLATES_LOADING               = 50039, // "Loading Game Object Templates..."
    LANG_WORLD_LOAD_GO_TEMPLATES_LOADED                = 50040, // ">> Loaded %u game object templates"
    LANG_WORLD_LOAD_SPELL_CHAIN_LOADING                = 50041, // "Loading Spell Chain Data..."
    LANG_WORLD_LOAD_SPELL_CHAIN_LOADED                 = 50042, // ">> Loaded %u spell chains"
    LANG_WORLD_LOAD_SPELL_REQUIRED_LOADING             = 50043, // "Loading Spell Required Data..."
    LANG_WORLD_LOAD_SPELL_REQUIRED_EMPTY               = 50044, // ">> Loaded 0 spell required records"
    LANG_WORLD_LOAD_SPELL_REQUIRED_LOADED              = 50045, // ">> Loaded %u spell required records"
    LANG_WORLD_LOAD_SPELL_ELIXIR_TYPES_LOADING         = 50046, // "Loading Spell Elixir types..."
    LANG_WORLD_LOAD_SPELL_ELIXIR_TYPES_EMPTY           = 50047, // ">> Loaded 0 spell elixir definitions"
    LANG_WORLD_LOAD_SPELL_ELIXIR_TYPES_LOADED          = 50048, // ">> Loaded %u spell elixir definitions"
    LANG_WORLD_LOAD_SPELL_LEARN_SKILLS_LOADING         = 50049, // "Loading Spell Learn Skills..."
    LANG_WORLD_LOAD_SPELL_LEARN_SKILLS_LOADED          = 50050, // ">> Loaded %u Spell Learn Skills from DBC"
    LANG_WORLD_LOAD_SPELL_LEARN_SPELLS_LOADING         = 50051, // "Loading Spell Learn Spells..."
    LANG_WORLD_LOAD_SPELL_LEARN_SPELLS_EMPTY           = 50052, // ">> Loaded 0 spell learn spells"
    LANG_WORLD_LOAD_SPELL_LEARN_SPELLS_LOADED          = 50053, // ">> Loaded %u spell learn spells + %u found in DBC"
    LANG_WORLD_LOAD_SPELL_PROC_EVENT_LOADING           = 50054, // "Loading Spell Proc Event conditions..."
    LANG_WORLD_LOAD_SPELL_PROC_EVENT_EMPTY             = 50055, // ">> Loaded 0 spell proc event conditions"
    LANG_WORLD_LOAD_SPELL_PROC_EVENT_LOADED_1          = 50056, // ">> Loaded %u extra spell proc event conditions +%u custom"
    LANG_WORLD_LOAD_SPELL_PROC_EVENT_LOADED_2          = 50057, // ">> Loaded %u extra spell proc event conditions"
    LANG_WORLD_LOAD_SPELL_BONUS_LOADING                = 50058, // "Loading Spell Bonus Data..."
    LANG_WORLD_LOAD_SPELL_BONUS_EMPTY                  = 50059, // ">> Loaded 0 spell bonus data"
    LANG_WORLD_LOAD_SPELL_BONUS_LOADED                 = 50060, // ">> Loaded %u extra spell bonus data"
    LANG_WORLD_LOAD_AGGRO_SPELL_LOADING                = 50061, // "Loading Aggro Spells Definitions..."
    LANG_WORLD_LOAD_NPC_TEXTS_LOADING                  = 50062, // "Loading NPC Texts..."
    LANG_WORLD_LOAD_ENCHANT_SPELLS_PROC_LOADING        = 50063, // "Loading Enchant Spells Proc datas..."
    LANG_WORLD_LOAD_ENCHANT_SPELLS_PROC_LOADED_1       = 50064, // ">> Loaded %u spell enchant proc event conditions"
    LANG_WORLD_LOAD_ENCHANT_SPELLS_PROC_LOADED_2       = 50065, // ">> Loaded %u enchant proc data definitions"
    LANG_WORLD_LOAD_ITEM_RANDOM_ENCHANT_LOADING        = 50066, // "Loading Item Random Enchantments Table..."
    LANG_WORLD_LOAD_ITEM_RANDOM_ENCHANT_LOADED         = 50067, // ">> Loaded %u Item Enchantment definitions"
    LANG_WORLD_LOAD_ITEM_RANDOM_ENCHANT_EMPTY          = 50068, // ">> Loaded 0 Item Enchantment definitions. DB table `item_enchantment_template` is empty."
    LANG_WORLD_LOAD_ITEMS_LOADING                      = 50069, // "Loading Items..."
    LANG_WORLD_LOAD_ITEMS_STORAGE_LOADING              = 50070, // ">> Loading temporary ItemStorage"
    LANG_WORLD_LOAD_ITEMS_STORAGE_LOADED               = 50071, // ">> Temporary ItemStorage loaded, modifying..."
    LANG_WORLD_LOAD_ITEMS_MODIFIED_1                   = 50072, // ">> Item Templates modified. Temp storage freed."
    LANG_WORLD_LOAD_ITEMS_MODIFIED_2                   = 50073, // "   Items will be removed from players at next relogin if required."
    LANG_WORLD_LOAD_ITEMS_MODIFIED_3                   = 50074, // ">> Now checking data."
    LANG_WORLD_LOAD_ITEMS_LOADED                       = 50075, // ">> Loaded %u item prototypes"
