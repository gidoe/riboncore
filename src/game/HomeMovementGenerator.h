...
#ifndef RIBON_HOMEMOVEMENTGENERATOR_H
#define RIBON_HOMEMOVEMENTGENERATOR_H
...
template < class T >
class RIBON_DLL_SPEC HomeMovementGenerator;

template <>
class RIBON_DLL_SPEC HomeMovementGenerator<Creature>
